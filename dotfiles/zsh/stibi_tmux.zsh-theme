...
export BATTERY_CHARGING_SYMBOL="⚡"
GIT_DIRTY_SYMBOL=""
GIT_CLEAN_SYMBOL=""
FREE_RAM_SYMBOL=""
CPU_LOAD_SYMBOL=""
...
calculatePromptWidth() {
    ...
    (( promptWidth = $STIBI_THEME_PROMPT_WIDTH + $STIBI_THEME_TIMESTAMP_WIDTH \
        + $STIBI_THEME_PWD_WIDTH + $STIBI_THEME_GIT_PROMPT_WIDTH ))
    echo $promptWidth
}
...
calculateAdjustedPwdWidth() {
    ...
    (( adjustedPwdWidth = $totalTerminalWidth - $STIBI_THEME_PROMPT_WIDTH - $STIBI_THEME_TIMESTAMP_WIDTH - $STIBI_THEME_GIT_PROMPT_WIDTH ))
